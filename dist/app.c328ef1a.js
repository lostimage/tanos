...
document.addEventListener('DOMContentLoaded', function () {
  var canvasProto = document.getElementById('canvas');
  var wrapper = document.querySelector('.flex-wrapper');

  var create = function create(item, container) {
    return (0, _html2canvas.default)(item).then(function (canvas) {
      ...
      for (var f = 0; f < width; f++) {
        for (var k = 0; k < height; k++) {
          for (var j = 0; j < 2; j++) {
            var pixel = 4 * (k * width + f);
            var canvasNumber = Math.floor(36 * Math.random());
      ...
      datum.forEach(function (imageData, i) {
        ...
        setTimeout(function () {
          ...
          cloned.style.transform = "rotate(".concat(15 * Math.random(), "deg) translate(").concat(160 * Math.cos(angle), "px , ").concat(160 * Math.sin(angle), "px)");
  ...
  var items = document.querySelectorAll('.canvas-proto');
...
},{"html2canvas":"node_modules/html2canvas/dist/html2canvas.js","./style.scss":"style.scss"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
